...
const testName = 'Test Bad Login flow';
const testUrl = 'https://sdkapp.petrov.ca/authn-basic/?amUrl=https://default.forgeops.petrov.ca/am&un=sdkuser&pw=wrong_password_123!';
    ...
    cbt.browsers.forEach((browser) => {
        ...
        test(`${testName} with ${browser.browserName}`, async () => {
            try {
                ...
                await driver.wait(until.elementLocated(By.css(".Auth_Error")), 5000);
                ...
                assert(await driver.findElement(By.xpath("//p[contains(.,\'Error: Auth_Error\')]")).getText() == "Error: Auth_Error");
